...
namespace P9_714240062
{
    public partial class Form1 : Form
    {
        ...
        public void Tampil()
        {
            ...
            DataMahasiswa.Columns[1].HeaderText = "Nama Mahasiswa";
            DataMahasiswa.Columns[2].HeaderText = "Angkatan";
            DataMahasiswa.Columns[3].HeaderText = "Alamat";
            DataMahasiswa.Columns[4].HeaderText = "Email";
            DataMahasiswa.Columns[5].HeaderText = "No. Telepon";
        ...
        {
            {
                DialogResult pesan = MessageBox.Show("Apakah anda yakin ingin menghapus data ini?", "Perhatian", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
